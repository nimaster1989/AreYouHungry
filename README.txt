...
Packages:
    ...
    - comp3350.Group2.areyouhungry.presistence //I think this is spelt wrong
      This package is in charge of the persistence layer that takes what was passed to it from the business
      layer and gets from the"database" what is required. Right now there is no actual database so
      it just fetches it from an array list.
